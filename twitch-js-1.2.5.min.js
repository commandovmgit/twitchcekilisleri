  ...
  return (function (e) {
      ...
      (function (t) {
        var s =
          ...
          n = {
            ...
            isFinite: function (e) {
              return Number.isFinite(e) && !Number.isNaN(parseFloat(e));
            },
            isInteger: function (e) {
              return !Number.isNaN(n.toNumber(e, 0));
            },
            ...
            addWord: function (e, t) {
              return 0 !== e.length ? e + " " + t : t;
            },
            channel: function (e) {
              var t = void 0 === e || null === e ? "" : e;
              return "#" === t.charAt(0)
                ? t.toLowerCase()
                : "#" + t.toLowerCase();
            },
            extractNumber: function (e) {
              for (var t = e.split(" "), s = 0; t.length > s; s++)
            ...
            merge: function (e, t) {
              return (
                Object.keys(t).forEach(function (s) {
                  try {
                    e[s] =
                      t[s].constructor === Object ? n.merge(e[s], t[s]) : t[s];
                  } catch (n) {
                    e[s] = t[s];
                  }
                }),
    ...
    function (e, t, s) {
      ...
      "function" != typeof String.prototype.includes &&
        (String.prototype.includes = function () {
          return -1 !== String.prototype.indexOf.apply(void 0, n);
        }),
        "function" != typeof String.prototype.startsWith &&
          (String.prototype.startsWith = function (e, t) {
            return String.prototype.indexOf(e, t || 0) === t;
          }),
        "function" != typeof Object.setPrototypeOf &&
          (Object.setPrototypeOf = function (e, t) {
            return (e.__proto__ = t), e;
          }),
        (e.exports = { client: i, Client: i });
    },
    function (e, t, s) {
      "use strict";
      (function (t) {
        var n = s(4),
          ...
          a = s(10),
          c = s(11),
          l = t.WebSocket || t.MozWebSocket || s(12),
          u = s(0),
          h = function e(t) {
            ...
            this.setMaxListeners(0),
              ...
              (this.clientId = u.get(this.opts.options.clientId, null)),
              (this.maxReconnectAttempts = u.get(
                this.opts.connection.maxReconnectAttempts,
                1 / 0
              )),
              (this.maxReconnectInterval = u.get(
                this.opts.connection.maxReconnectInterval,
                3e4
              )),
              (this.reconnect = u.get(this.opts.connection.reconnect, !1)),
              (this.reconnectDecay = u.get(
                this.opts.connection.reconnectDecay,
                1.5
              )),
              (this.reconnectInterval = u.get(
              ...
              (this.secure = u.get(this.opts.connection.secure, !1)),
              (this.emotes = ""),
              (this.emotesets = {}),
              (this.channels = []),
        ...
        u.inherits(h, o),
          ...
          (h.prototype.handleMessage = function (e) {
            ...
            if (!u.isNull(e)) {
              ...
              if (
                ((e.tags = a.badges(a.emotes(e.tags))),
                e.tags &&
                  Object.keys(e.tags).forEach(function (t) {
                    "emote-sets" !== t &&
                      "ban-duration" !== t &&
                      "bits" !== t &&
                      (u.isBoolean(e.tags[t])
                        ? (e.tags[t] = null)
                        : "1" === e.tags[t]
                        ? (e.tags[t] = !0)
                        : "0" === e.tags[t] && (e.tags[t] = !1));
                  }),
                u.isNull(e.prefix))
              )
                switch (e.command) {
                ...
                switch (e.command) {
                  ...
                  case "372":
                    var o = (function () {
                      t.log.info("Connected to server."),
                        (t.userstate["#tmijs"] = {}),
                        t.emits(
                          ["connected", "_promiseConnect"],
                          [[t.server, t.port], [null]]
                        ),
                        (t.reconnections = 0),
                        (t.reconnectTimer = t.reconnectInterval),
                        (t.pingLoop = setInterval(function () {
                          u.isNull(t.ws) ||
                            2 === t.ws.readyState ||
                            3 === t.ws.readyState ||
                            t.ws.send("PING"),
                      ...
                      var e = new c.queue(2e3),
                        s = u.union(t.opts.channels, t.channels);
                      t.channels = [];
                  ...
                  case "NOTICE":
                    switch (i) {
                      ...
                      case "emote_only_on":
                        this.log.info(
                          "[" + s + "] This room is now in emote-only mode."
                        ),
                          this.emits(
                      ...
                      case "r9k_off":
                        this.log.info(
                          "[" + s + "] This room is no longer in r9k mode."
                        ),
                          this.emits(
                      ...
                      case "hosts_remaining":
                        this.log.info("[" + s + "] " + n);
                        var m = Number.isNaN(n.charAt(0)) ? 0 : n.charAt(0);
                        this.emits(
                          ["notice", "_promiseHost"],
                          [
                            [s, i, n],
                  ...
                  case "USERNOTICE":
                    if ("resub" === i) {
                      var f = e.tags["display-name"] || e.tags.login,
                        p = e.tags["msg-param-sub-plan"],
                        d = u.replaceAll(
                          u.get(e.tags["msg-param-sub-plan-name"], null),
                          {
                            "\\\\s": " ",
                            "\\\\:": ";",
                            "\\\\\\\\": "\\",
                        ...
                        g = u.get(~~e.tags["msg-param-months"], null),
                        _ = p.includes("Prime"),
                        b = e.tags;
                      b && (b["message-type"] = "resub"),
                        this.emits(
                          ["resub", "subanniversary"],
                          [
                            [s, f, g, n, b, { prime: _, plan: p, planName: d }],
                            [s, f, g, n, b, { prime: _, plan: p, planName: d }],
                          ]
                        );
                    } else if ("sub" === i) {
                      var y = e.tags["display-name"] || e.tags.login,
                        v = e.tags["msg-param-sub-plan"],
                        w = u.replaceAll(
                          u.get(e.tags["msg-param-sub-plan-name"], null),
                          {
                            "\\\\s": " ",
                        ...
                        C = v.includes("Prime"),
                        k = e.tags;
                      k && (k["message-type"] = "sub"),
                        this.emit(
                          "subscription",
                          s,
                          y,
                          { prime: C, plan: v, planName: w },
                          n,
                          k
                        );
                    } else if ("subgift" === i) {
                      var x = e.tags["display-name"] || e.tags.login,
                        T =
                          e.tags["msg-param-recipient-display-name"] ||
                          e.tags["msg-param-recipient-user-name"],
                        S = e.tags["msg-param-sub-plan"],
                        E = u.replaceAll(
                          u.get(e.tags["msg-param-sub-plan-name"], null),
                          {
                            "\\\\s": " ",
                  ...
                  case "HOSTTARGET":
                    if ("-" === n.split(" ")[0])
                      this.log.info("[" + s + "] Exited host mode."),
                        this.emits(
                      ...
                      this.log.info(
                        ...
                        this.emit("hosting", s, n.split(" ")[0], N);
                    }
                    break;
                  case "CLEARCHAT":
                    if (e.params.length > 1) {
                      var P = u.get(e.tags["ban-duration"], null),
                        L = u.replaceAll(u.get(e.tags["ban-reason"], null), {
                          "\\\\s": " ",
                          "\\\\:": ";",
                          "\\\\\\\\": "\\",
                          "\\r": "\r",
                    ...
                    (e.tags.username = this.username),
                      "mod" === e.tags["user-type"] &&
                        (this.moderators[this.lastJoined] ||
                          (this.moderators[this.lastJoined] = []),
                        0 >
                          this.moderators[this.lastJoined].indexOf(
                            this.username
                          ) &&
                          this.moderators[this.lastJoined].push(this.username)),
                      u.isJustinfan(this.getUsername()) ||
                        this.userstate[s] ||
                  ...
                  case "ROOMSTATE":
                    if (
                      (u.channel(this.lastJoined) === u.channel(e.params[0]) &&
                        this.emit("_promiseJoin", null),
                      (e.tags.channel = u.channel(e.params[0])),
                      this.emit("roomstate", u.channel(e.params[0]), e.tags),
                      e.tags.hasOwnProperty("slow") &&
                        !e.tags.hasOwnProperty("subs-only") &&
                        ("boolean" == typeof e.tags.slow
                          ? (this.log.info(
                              "[" + s + "] This room is no longer in slow mode."
                            ),
                            this.emits(
                          ...
                          : (this.log.info(
                              "[" + s + "] This room is now in slow mode."
                            ),
                            this.emits(
                      ...
                      e.tags.hasOwnProperty("followers-only") &&
                        !e.tags.hasOwnProperty("subs-only"))
                    )
                      if ("-1" === e.tags["followers-only"])
                        ...
                        var I = ~~e.tags["followers-only"];
                        this.log.info(
                          "[" + s + "] This room is now in follower-only mode."
                        ),
                          this.emits(
                            [
                              "followersonly",
                  ...
                  case "MODE":
                    "+o" === n
                      ? (this.moderators[s] || (this.moderators[s] = []),
                        0 > this.moderators[s].indexOf(e.params[2]) &&
                ...
                switch (e.command) {
                  ...
                  case "JOIN":
                    u.isJustinfan(this.getUsername()) &&
                      this.username === e.prefix.split("!")[0] &&
                      ((this.lastJoined = s),
                      this.channels.push(s),
                      this.log.info("Joined " + s),
                      this.emit("join", s, e.prefix.split("!")[0], !0)),
                      this.username !== e.prefix.split("!")[0] &&
                        this.emit("join", s, e.prefix.split("!")[0], !1);
                    break;
                  case "PART":
                    var A = !1,
                      R = void 0;
                    this.username === e.prefix.split("!")[0] &&
                      ...
                      (R = this.channels.indexOf(s)),
                      -1 !== R && this.channels.splice(R, 1),
                      (R = this.opts.channels.indexOf(s)),
                      -1 !== R && this.opts.channels.splice(R, 1),
                      this.log.info("Left " + s),
                      this.emit("_promisePart", null)),
                      this.emit("part", s, e.prefix.split("!")[0], A);
                    break;
                  case "WHISPER":
                    this.log.info(
                      "[WHISPER] <" + e.prefix.split("!")[0] + ">: " + n
                    ),
                      e.tags.hasOwnProperty("username") ||
                        (e.tags.username = e.prefix.split("!")[0]),
                      (e.tags["message-type"] = "whisper");
                    var D = u.channel(e.tags.username);
                    this.emits(
                      ["whisper", "message"],
                      [
                        [D, e.tags, n, !1],
                    ...
                    break;
                  case "PRIVMSG":
                    if ("jtv" === (e.tags.username = e.prefix.split("!")[0]))
                      if (n.includes("hosting you for")) {
                        var M = u.extractNumber(n);
                        this.emit(
                          "hosted",
                          s,
                          u.username(n.split(" ")[0]),
                          M,
                          n.includes("auto")
                        );
                      } else
          ...
          (h.prototype.connect = function () {
            ...
            return new Promise(function (t, s) {
              (e.server = u.get(
                ...
                (e.port = u.get(e.opts.connection.port, 80)),
                e.secure && (e.port = 443),
                443 === e.port && (e.secure = !0),
                (e.reconnectTimer = e.reconnectTimer * e.reconnectDecay),
                e.maxReconnectInterval > e.reconnectTimer ||
          ...
          (h.prototype._onOpen = function () {
            u.isNull(this.ws) ||
              ...
              (this.log.info(
                "Connecting to " + this.server + " on port " + this.port + ".."
              ),
              ...
              (this.password = u.password(
                u.get(this.opts.identity.password, "SCHMOOPIIE")
              )),
          ...
          (h.prototype._getPromiseDelay = function () {
            return this.currentLatency > 600 ? this.currentLatency + 100 : 600;
          }),
          (h.prototype._sendCommand = function (e, t, s, n) {
            ...
            return new Promise(function (o, r) {
              u.promiseDelay(e).then(function () {
                ...
                u.isNull(i.ws) || 2 === i.ws.readyState || 3 === i.ws.readyState
                  ? r("Not connected to server.")
                  : (u.isNull(t)
                      ? (i.log.info("Executing command: " + s), i.ws.send(s))
                      : (i.log.info(
                          "[" + u.channel(t) + "] Executing command: " + s
                        ),
                        i.ws.send("PRIVMSG " + u.channel(t) + " :" + s)),
                    n(o, r));
            });
          }),
          (h.prototype._sendMessage = function (e, t, s, n) {
            ...
            return new Promise(function (o, r) {
              if (
                ...
                2 === i.ws.readyState ||
                3 === i.ws.readyState ||
                u.isJustinfan(i.getUsername())
              )
                r("Not connected to server.");
              else {
                if (
                  (i.userstate[u.channel(t)] ||
                    (i.userstate[u.channel(t)] = {}),
                  s.length >= 500)
                ) {
                  var c = u.splitLine(s, 500);
                  (s = c[0]),
                    setTimeout(function () {
                ...
                Object.keys(i.emotesets).forEach(function (e) {
                  i.emotesets[e].forEach(function (e) {
                    if (u.isRegex(e.code))
                      return a.emoteRegex(s, e.code, e.id, l);
                    a.emoteString(s, e.code, e.id, l);
                  });
                });
                var h = u.merge(
                  i.userstate[u.channel(t)],
                  a.emotes({ emotes: a.transformEmotes(l) || null })
                );
                s.match(/^\u0001ACTION ([^\u0001]+)\u0001$/)
                  ? ((h["message-type"] = "action"),
                    i.log.info(
                      "[" +
                        u.channel(t) +
                        "] *<" +
              ...
              this.api(
                {
                  ...
                  headers: {
                    Authorization:
                      "OAuth " +
                      u
                        .password(u.get(this.opts.identity.password, ""))
                        .replace("oauth:", ""),
          ...
          (h.prototype.isMod = function (e, t) {
            return (
              this.moderators[u.channel(e)] ||
                (this.moderators[u.channel(e)] = []),
              0 <= this.moderators[u.channel(e)].indexOf(u.username(t))
            );
          }),
          (h.prototype.readyState = function () {
            return u.isNull(this.ws)
              ? "CLOSED"
          ...
          (h.prototype.disconnect = function () {
            var e = this;
            return new Promise(function (t, s) {
              u.isNull(e.ws) || 3 === e.ws.readyState
                ? (e.log.error(
          ...
          (h.prototype.utils = {
            levenshtein: function (e, t, s) {
              ...
              var r = Array(i + 1),
                ...
                f = void 0,
                p = void 0;
              for (l = 0; i >= l; l++) r[l] = 1 * l;
              for (c = 0; n > c; c++) {
                for (a[0] = r[0] + 1, l = 0; i > l; l++)
                  (h = r[l] + (e[c] === t[l] ? 0 : 1)),
                    (m = r[l + 1] + 1),
                    h > m && (h = m),
                    (f = a[l] + 1),
            ...
            raffle: {
              init: function (e) {
                this.raffleChannels || (this.raffleChannels = {}),
                  this.raffleChannels[u.channel(e)] ||
                    (this.raffleChannels[u.channel(e)] = []);
              },
              enter: function (e, t) {
                this.init(e),
                  this.raffleChannels[u.channel(e)].push(t.toLowerCase());
              },
              leave: function (e, t) {
                this.init(e);
                var s = this.raffleChannels[u.channel(e)].indexOf(
                  u.username(t)
                );
                return (
                  s >= 0 && (this.raffleChannels[u.channel(e)].splice(s, 1), !0)
                );
              },
              pick: function (e) {
                this.init(e);
                var t = this.raffleChannels[u.channel(e)].length;
                return 1 > t
                  ? null
                  : this.raffleChannels[u.channel(e)][
              ...
              reset: function (e) {
                this.init(e), (this.raffleChannels[u.channel(e)] = []);
              },
              count: function (e) {
                return (
                  this.init(e),
                  this.raffleChannels[u.channel(e)]
                    ? this.raffleChannels[u.channel(e)].length
                    : 0
                );
              },
              isParticipating: function (e, t) {
                return (
                  this.init(e),
                  0 <= this.raffleChannels[u.channel(e)].indexOf(u.username(t))
                );
              },
            },
            symbols: function (e) {
              for (var t = 0, s = 0; e.length > s; s++) {
            ...
            uppercase: function (e) {
              var t = e.length,
                s = e.match(/[A-Z]/g);
              return u.isNull(s) ? 0 : s.length / t;
            },
          }),
          void 0 !== e && e.exports && (e.exports = h),
          "undefined" != typeof window &&
            ((window.tmi = {}), (window.tmi.client = h));
      }.call(t, s(3)));
    },
    function (e, t) {
      var s;
    ...
    function (e, t, s) {
      ...
      e.exports = function (e, t) {
        var s =
          null === i.get(e.url, null) ? i.get(e.uri, null) : i.get(e.url, null);
        if (
          (i.isURL(s) ||
            (s =
              "/" === s.charAt(0)
                ? "https://api.twitch.tv/kraken" + s
                : "https://api.twitch.tv/kraken/" + s),
          i.isNode())
        )
          n(i.merge(e, { url: s, method: "GET", json: !0 }), function (
            e,
            s,
            n
          ) {
          ...
          var o = i.merge(e, { url: s, method: "GET", headers: {} }),
            r = new XMLHttpRequest();
          r.open(o.method, o.url, !0),
            Object.keys(o).forEach(function (e) {
              return r.setRequestHeader(e, o.headers[e]);
            }),
            (r.responseType = "json"),
            r.addEventListener("load", function () {
              4 === r.readyState &&
                (200 !== r.status
                  ? t(r.status, null, null)
                  : t(null, null, r.response));
            }),
            r.send();
        } else {
          var a = document.createElement("script"),
            c = "jsonp_callback_" + Math.round(1e5 * Math.random());
          (window[c] = function (e) {
            delete window[c], document.body.removeChild(a), t(null, null, e);
          }),
            (a.src = s + (0 > s.indexOf("?") ? "?" : "&") + "callback=" + c),
    ...
    function (e, t) {
      ...
      function r() {
        d &&
          f &&
          ((d = !1), f.length ? (p = f.concat(p)) : (g = -1), p.length && a());
      }
      function a() {
        if (!d) {
          var e = i(r);
      ...
      (m.nextTick = function (e) {
        ...
        if (arguments.length > 1)
          for (var s = 1; arguments.length > s; s++) t[s - 1] = arguments[s];
        p.push(new c(e, t)), 1 !== p.length || d || i(a);
      }),
    ...
    function (e, t, s) {
      ...
      function r(e) {
        ...
        return (
          (e = u.channel(e)),
          this._sendCommand(this._getPromiseDelay(), e, "/r9kbeta", function (
            s,
            n
          ) {
      ...
      function c(e, t) {
        ...
        return (
          (e = u.channel(e)),
          (t = u.get(t, 300)),
          this._sendCommand(this._getPromiseDelay(), e, "/slow " + t, function (
            n,
            i
          ) {
      ...
      function l(e) {
        ...
        return (
          (e = u.channel(e)),
          this._sendCommand(this._getPromiseDelay(), e, "/slowoff", function (
            s,
            n
          ) {
      ...
      e.exports = {
        action: function (e, t) {
          return (
            (e = u.channel(e)),
            (t = "ACTION " + t + ""),
            this._sendMessage(this._getPromiseDelay(), e, t, function (s) {
              s([e, t]);
            })
          );
        },
        ...
        clear: function (e) {
          ...
          return (
            (e = u.channel(e)),
            this._sendCommand(this._getPromiseDelay(), e, "/clear", function (
              s,
              n
            ) {
        ...
        mods: function (e) {
          ...
          return (
            (e = u.channel(e)),
            this._sendCommand(this._getPromiseDelay(), e, "/mods", function (
              s,
              n
            ) {
        ...
        r9kmodeoff: a,
        raw: function (e) {
          return this._sendCommand(this._getPromiseDelay(), null, e, function (
            t
          ) {
            t([e]);
          });
          ...
          return (
            ...
            t.startsWith("\\")
              ? "me " === t.substr(1, 3)
                ...
                : this._sendCommand(this._getPromiseDelay(), e, t, function (
                    s
                  ) {
                    s([e, t]);
                  })
      ...
      String.prototype.startsWith ||
        ...
        (n.prototype.emits = function (e, t) {
          for (var s = 0; e.length > s; s++)
            t[s].unshift(e[s]), this.emit.apply(this, t[s]);
        }),
    ...
    function (e, t, s) {
      ...
      function n(e) {
        return function (t) {
          r[o] > r[e] ||
            console.log("[" + i.formatDate(new Date()) + "] " + e + ": " + t);
        };
      }
      var i = s(0),
        o = "info",
    ...
    function (e, t, s) {
      ...
      e.exports = {
        ...
        emoteRegex: function (e, t, s, i) {
          for (
            var o = /\S+/g,
              r = RegExp("(\\b|^|s)" + n.unescapeHtml(t) + "(\\b|$|s)'"),
              a = void 0;
            null !== (a = o.exec(e));

          )
            r.test(a[0]) && i[s] && i[s].push([a.index, o.lastIndex - 1]);
        },
        emoteString: function (e, t, s, i) {
          for (var o = /\S+/g, r = void 0; null !== (r = o.exec(e)); )
            r[0] === n.unescapeHtml(t) &&
              ((i[s] = i[s] || []), i[s].push([r.index, o.lastIndex - 1]));
        },
        ...
        msg: function (e) {
          ...
          if (64 === e.charCodeAt(0)) {
            ...
            for (var i = e.slice(1, n).split(";"), o = 0; i.length > o; o++) {
              var r = i[o];
              t.tags[r.split("=")[0]] = r.substring(r.indexOf("=") + 1) || !0;
            }
            s = n + 1;
          }
