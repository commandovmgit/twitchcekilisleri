...
function relayToEmbeddedChat(t) {
    ...
    return postman ? void postman.setAttribute("data-in", JSON.stringify(t)) : void console.log("Twitch Giveaways: Can't relay to chat listener, postman not loaded yet.")
}

var channel = getChannelName();
var button = document.createElement("a");
button.className = "tgr-button button button--icon-only float-left";
button.title = chrome.i18n.getMessage("TWITCH_GIVEAWAYS_TITLE");
